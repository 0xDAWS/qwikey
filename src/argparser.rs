...
pub struct Args {
    #[clap(short, long, help = "Use the ASCII uppercase charset")]
    pub upper: bool,

    #[clap(short, long, help = "Use the ASCII lowercase charset")]
    pub lower: bool,

    #[clap(short, long, help = "Use the ASCII digits charset")]
    pub digits: bool,

    #[clap(short, long, help = "Use the ASCII special characters charset")]
    pub special: bool,
    ...
    #[clap(short = 'x', long = "hex", help = "Generate a hex string (lowercase)")]
    pub hexlower: bool,
